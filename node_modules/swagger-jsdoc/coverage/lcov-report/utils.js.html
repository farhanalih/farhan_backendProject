...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { promises as fs } from 'fs';
...
export function mergeDeep(first, second) {
  return mergeWith({}, first, second, (a, b) =&gt; (b === null ? <span class="branch-0 cbranch-no" title="branch not covered" >a </span>: undefined));
}
&nbsp;</pre></td></tr></table></pre>
